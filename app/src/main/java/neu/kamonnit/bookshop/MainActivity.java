...
public class MainActivity extends AppCompatActivity {
    ...
    //Create Inner Class
    private class MySynchronize extends AsyncTask<Void, Voice, String> {
        ...
        public MySynchronize(String urlString, Context context​) {
    ...
    public  void  clickSingIn(View view) {
        ...
        if (userString.equals("")  || passwordString.equals("")) {
            //Have Space
            MyAlert myAlert = new MyAlert();
            myAlert.myDialog(this, "คือโง่ตายมึงแท้ อิอ้วน", "รหัสผ่านจะของกะจำบ่ได้ อิปอบ");
    ...
    private void searchUserAnPassword() {
        ...
        MySynchronize mySynchronize = new MySynchronize(urlJSON, this);
